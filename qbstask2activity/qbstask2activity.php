...
class CBPQBSTask2Activity extends CBPActivity implements IBPEventActivity, IBPActivityExternalEventListener, IBPEventDrivenActivity
{
	...
	private static $arAllowedTasksFieldNames = array(
		...
		'ADD_IN_REPORT', 'AUDITORS', 'ALLOW_TIME_TRACKING', 'PARENT_ID','SE_PARAMETER'
	);
	...
	private function createTask()
	{
        ...
        $fields["SE_PARAMETER"] = array(
           [
               "VALUE" => $this->REQUIRE_RESULT,
	...
	public static function GetPropertiesDialog($documentType, $activityName, $arWorkflowTemplate, $arWorkflowParameters, $arWorkflowVariables, $arCurrentValues = null, $formName = "", $popupWindow = null, $currentSiteId = null)
	{
		...
		if (!is_array($arCurrentValues))
		{
            ...
            $arCurrentValues["REQUIRE_RESULT"] = $arCurrentActivity["Properties"]["REQUIRE_RESULT"];
	...
	public static function GetPropertiesDialogValues($documentType, $activityName, &$arWorkflowTemplate, &$arWorkflowParameters, &$arWorkflowVariables, $arCurrentValues, &$errors)
	{
        ...
        $properties["REQUIRE_RESULT"] = $arCurrentValues["REQUIRE_RESULT"];
		if (count($errors) > 0)
		{
			return false;
		}
